    ...
    <div className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
        ...
        <div className='flex flex-col md:flex-row item-center md:items-start md:gap-20'>
            ...
            <div className='flex flex-col item-center md:item-start mt-10 text-gray-600'>
                ...
                <p className='my-10 max-w-lg'>Discover your dream home with us! Whether you're buying, selling, or investing, we offer personalized service to guide you through every step of the real estate journey. With extensive market knowledge, expert advice, and a wide range of properties, we make your real estate goals a reality.</p>
                <button className='w-40 bg-blue-600 text-white px-8 py-2 rounded'>Learn more</button>
            </div>
